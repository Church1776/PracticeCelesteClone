...
CPPEXP="-lstdc++exp"
SRC_CORE="main.cpp base_lib.cpp platform_linux.cpp input.cpp gl_renderer.cpp"
SRC_DLLS=""
SRC_LIBS=""
SRC_PCHS=""
FILE_EXT=""
DLL_FILE_NAME="shared_lib.so"
LIB_FILE_NAME="static_lib.a"
LINKER_LIBS="-lX11 -lGL"
...
BIN_DIR="$PROJECT_DIR/bin"          ## <-- For exe, so, lib, pch output
